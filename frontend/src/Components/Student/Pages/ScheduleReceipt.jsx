...
const ScheduleReceipt = (props) =>
{
  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen bg-[url('Components\public\students-with-unif-tb.png')] bg-cover bg-center px-4 overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center gap-6 w-full max-w-sm shm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-md 2xl:max-w-md z-10">
        ...
        {/*   <button id='downloadBtn'
          className='border-2 px-5 rounded-lg p-1 transition duration-300 ease-in-out hover:bg-gray-100'
